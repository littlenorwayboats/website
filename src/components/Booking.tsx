  ...
  return (
    <>
      <div className="mx-auto mt-8 max-w-md">
        <label
          htmlFor={selectId}
          className="block text-center text-sm font-semibold tracking-[0.16em] text-gold uppercase"
        >
          Voyage package
        </label>
        <select
          ...
          className="mt-3 w-full appearance-none rounded-lg border border-white/15 bg-[#1a1a1a] px-4 py-3 text-center font-display text-parchment tracking-wide uppercase outline-none [background-image:linear-gradient(45deg,transparent_50%,#d4b483_50%),linear-gradient(135deg,#d4b483_50%,transparent_50%)] [background-position:calc(100%-1.4rem)_calc(1.1rem+2px),calc(100%-1rem)_calc(1.1rem+2px)] [background-repeat:no-repeat] [background-size:6px_6px,6px_6px] focus-visible:border-neon"
        >
  ...
  return (
    <>
      <div className="mx-auto mt-8 max-w-md">
        ...
        <div className="mt-3 h-[3.25rem] rounded-lg border border-white/15 bg-[#1a1a1a]" />
      </div>
